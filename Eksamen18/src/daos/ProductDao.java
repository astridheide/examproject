...
//				Product product = new Product(product_id, brand, model, product_type, product_year, capacity, drive,
//						price, description);
...
//		Product result = null;
		...
		/*
		 * Notice that we are using the name of the database-table as a prefix to the
		 * attribute name. This makes it possible make a distinction between attributes
		 * with the same name coming from different tables when we are doing
		 * join-selects.
		 */
